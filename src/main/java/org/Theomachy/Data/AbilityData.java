...
public interface AbilityData
{
	...
	int KIMETHU_NO_YAIBA_ABILITY_NUMBER= EnumSet.range(AbilityInfo.Itarodi, AbilityInfo.Jogo).size();

	int JUJUTSU_KAISEN_ABILITY_NUMBER =EnumSet.range(AbilityInfo.Zenitsu, AbilityInfo.Zenitsu).size();
