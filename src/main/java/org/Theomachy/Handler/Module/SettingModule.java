...
public class SettingModule {
    ...
    public static void openSettingInventory(Player player) {
        ...
        inventory.setItem(0, CommonModule.setItem(Theomachy.STARTING_INVENTORY_CLEAR ? Material.WHITE_WOOL : Material.RED_WOOL, 1, TheomachyMessage.STARTING_INVENTORY_CLEAR.getMessage()));
        inventory.setItem(2, CommonModule.setItem(Theomachy.STARTING_GIVE_ITEM ? Material.WHITE_WOOL : Material.RED_WOOL, 1, TheomachyMessage.STARTING_GIVE_ITEM.getMessage()));
        inventory.setItem(4, CommonModule.setItem(Theomachy.STARTING_ENTITY_CLEAR ? Material.WHITE_WOOL : Material.RED_WOOL, 1, TheomachyMessage.STARTING_ENTITY_CLEAR.getMessage()));
        inventory.setItem(6, CommonModule.setItem(Theomachy.IGNORE_BED ? Material.WHITE_WOOL : Material.RED_WOOL, 1, TheomachyMessage.IGNORE_BED.getMessage()));
        inventory.setItem(8, CommonModule.setItem(Theomachy.FAST_START ? Material.WHITE_WOOL : Material.RED_WOOL, 1, TheomachyMessage.FAST_START.getMessage()));
        inventory.setItem(9, CommonModule.setItem(Theomachy.SERVER_AUTO_SAVE ? Material.WHITE_WOOL : Material.RED_WOOL, 1, TheomachyMessage.SERVER_AUTO_SAVE.getMessage()));
        inventory.setItem(11, CommonModule.setItem(Theomachy.ANIMAL_SPAWN ? Material.WHITE_WOOL : Material.RED_WOOL, 1, TheomachyMessage.ANIMAL_SPAWN.getMessage()));
        inventory.setItem(13, CommonModule.setItem(Theomachy.MONSTER_SPAWN ? Material.WHITE_WOOL : Material.RED_WOOL, 1, TheomachyMessage.MONSTER_SPWAN.getMessage()));
        inventory.setItem(15, CommonModule.setItem(Theomachy.GAMBLING ? Material.WHITE_WOOL : Material.RED_WOOL, 1, TheomachyMessage.GAMBLING_ACCEPT.getMessage()));
