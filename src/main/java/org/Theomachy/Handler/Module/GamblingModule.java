...
public class GamblingModule {
    ...
    static int cobblePercentage = 50;
    static int oakPercentage = 30;
    static int nullPercentage = 15;
    static int ironPercentage = 4;
    static int diamondPercentage = 1;

    static int cobbleCount = 32;
    static int oakCount = 3;
    static int ironCount = 4;
    static int diamondCount = 10;
