...
public class GameReadyTimer extends TimerTask {
    ...
    public GameReadyTimer() {
        ...
        setting[0] = Theomachy.INVENTORY_CLEAR ? NamedTextColor.AQUA + "ON" : NamedTextColor.RED + "OFF";
        setting[1] = Theomachy.GIVE_ITEM ? NamedTextColor.AQUA + "ON" : NamedTextColor.RED + "OFF";
        setting[2] = Theomachy.IGNORE_BED ? NamedTextColor.AQUA + "ON" : NamedTextColor.RED + "OFF";
        setting[3] = Theomachy.AUTO_SAVE ? NamedTextColor.AQUA + "ON" : NamedTextColor.RED + "OFF";
        setting[4] = Theomachy.ANIMAL ? NamedTextColor.AQUA + "ON" : NamedTextColor.RED + "OFF";
        setting[5] = Theomachy.MONSTER ? NamedTextColor.AQUA + "ON" : NamedTextColor.RED + "OFF";
        setting[7] = Theomachy.ENTITIES_REMOVE ? NamedTextColor.AQUA + "ON" : NamedTextColor.RED + "OFF";
        difficulty = null;
        switch (Theomachy.DIFFICULTY) {
            case 0 -> {
                setting[6] = NamedTextColor.GREEN + "평화로움";
                difficulty = Difficulty.PEACEFUL;
            }
            case 1 -> {
                setting[6] = NamedTextColor.AQUA + "쉬움";
                difficulty = Difficulty.EASY;
            }
            case 2 -> {
                setting[6] = NamedTextColor.YELLOW + "보통";
                difficulty = Difficulty.NORMAL;
            }
            case 3 -> {
                setting[6] = NamedTextColor.GREEN + "어려움";
                difficulty = Difficulty.HARD;
            }
            default -> {
                setting[6] = NamedTextColor.GREEN + "쉬움";
                difficulty = Difficulty.EASY;
            }
        }
                    ...
                    for (Player player : playerList) {
                        ...
                        if (teamName != null) {
                            ...
                            if (location != null)
                                ...
                                player.sendMessage(NamedTextColor.RED + "팀의 스폰지역이 설정되지 않아 기본 스폰지역으로 이동합니다.");
                                Bukkit.getScheduler().runTask(Theomachy.getPlugin(), () -> {
                                    player.teleport(spawnLocation);
                                });
                            }
                        } else {
                            player.sendMessage(NamedTextColor.RED + "팀이 지정되지 않아 기본 스폰지역으로 이동합니다.");
                            Bukkit.getScheduler().runTask(Theomachy.getPlugin(), () -> {
                                player.teleport(spawnLocation);
                            });
                        }
